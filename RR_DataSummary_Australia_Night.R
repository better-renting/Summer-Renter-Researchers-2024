...
# Export CSV
tryCatch({
  write.csv(State_summary, "data_summaries/State/S_Australia_summary_Night.csv", row.names = FALSE)
  cat("Successfully wrote Australia_summary_Night to CSV.\n")
}, error = function(e) {
  cat("Failed to write Australia_summary_Night to CSV. Error: ", e$message, "\n")
})
